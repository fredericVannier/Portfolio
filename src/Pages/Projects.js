              ...
              <div className="project">
                <div className="project-informations">
                  ...
                  <p className="project-details">
                    Space Explorer is a 2D space shooter game made with
                    javascript. The goal of this project was to work with{" "}
                    <span>
                    ...
                    <br />
                    <br />
                    You are travelling in space when aliens find you and try to
                    kill you. You have to destroy as much enemies as you can and
                    get the best score.
                  </p>
            ...
            <div className="project-container">
              ...
              <div className="project">
                <div className="project-informations">
                  ...
                  <p className="project-details">
                    Petsit is an application designed for mobile (iphone X
                    viewport only at the moment). For this project, my colleague
                    and me used
                    <span>
                      {" "}
                    ...
                    . <br />
                    <br />
                    This application connects pet owners to find people to take
                    care of their animals for a short period of time.
                    <br />
                    <br />{" "}
                    <span>
                      Disclaimer: Deployment isn't working at this time, I will
                      redo this application with React soon!
                    </span>
                  </p>
                  <div className="links-section">
                    <a
            ...
            <div className="project-container">
              ...
              <div className="project">
                <div className="project-informations">
                  ...
                  <p className="project-details">
                    Top·it was made to practice basic CRUD (Create, Read,
                    Update, Delete) I managed to create the front-end and the
                    back-end by myself using{" "}
                    <span>
                    ...
                    account and start posting topics or you can vote, favorite
                    and comment an existing one.
                  </p>
                  <div className="links-section">
                    <a
